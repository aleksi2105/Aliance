...
<section class="section">
  <div class="container blog">
    ...
    <div class="blog-pagination">
      <button class="blog-pagination-item blog-pagination-item-active">1</button>
      <button class="blog-pagination-item">2</button>
      <button class="blog-pagination-item">3</button>
      <button class="blog-pagination-item">4</button>
      <button class="blog-pagination-item">5</button>
    </div>
  </div>
</section>
<!-- /.section blog -->
