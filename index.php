...
<html lang="ru">
  <head>
    ...
    <title>Aliance Production - Главная</title>
    <script>
  ...
  <body class="front-page">
    ...
    <nav class="navbar">
      ...
      <a href="./" class="header-logo" aria-label="Перейти на главную страницу">
        ...
        <div class="swiper blog-slider">
          ...
          <div class="swiper-wrapper">
            ...
            <a href="#" class="swiper-slide blog-card" aria-label="Прочитать статью">
              ...
              <h3 class="blog-card-title">Будущий заголовок статьи</h3>
              <p class="blog-card-text">Будущий текст</p>
            </a>
           </div>
