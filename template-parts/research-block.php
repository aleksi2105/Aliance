<section class="section research">
  ...
  <div class="researchs-buttons primary-buttons-wrapper">
    ...
    <div class="researchs-button-next primary-button-next">
        <svg class="arrows-steps" width="36" height="24">
