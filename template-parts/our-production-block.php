<section class="section our-production">
  <div class="container production-wrapper">
    <div class="production-description">
      ...
      <p class="production-text2">Реализация намеченных плановых заданий, а также свежий взгляд на привычные вещи - безусловно открывает новые горизонты для соответствующих условий активизации. Предварительные выводы неутешительны: экономическая повестка сегодняшнего дня требует анализа анализа существующих паттернов поведения.</p>
       ...
       <ul class="clients-list">
              ...
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use xlink:href="./img/sprite.svg#shieldAl"></use>
                </svg>
    ...
    <picture class="production-lab-img">
        ...
        <img src="./img/laboratory.png" alt="Лаборант">
    </picture>
  </div>
 </section>