...
<section class="section seo">
  <div class="container">
    ...
    <div class="seo-button-group">
    <a href="" class="arrow-load"><svg  width="24" height="24">
      <use xlink:href="./img/sprite.svg#arrow-load"></use>
    </svg></a>
    <a href="#" class="button-link-more">Читать больше</a>
    </div>
  </div>
